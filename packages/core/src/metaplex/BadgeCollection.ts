...
export const BADGE_DEFINITIONS: Record<BadgeType, Omit<BadgeMetadata, 'type'>> = {
    [BadgeType.FIRST_SWAP]: {
        name: 'First Swap',
        description: 'Completed your first token swap on Jupiter',
        rarity: BadgeRarity.COMMON,
        image: 'https://defi-quest-home.netlify.app/badges/first-swap.png',
        attributes: [
    ...
    [BadgeType.VOLUME_TRADER]: {
        name: 'Volume Trader',
        description: 'Completed $100+ in trading volume',
        rarity: BadgeRarity.RARE,
        image: 'https://defi-quest-home.netlify.app/badges/volume-trader.png',
        attributes: [
            { traitType: 'Category', value: 'Trading' },
            { traitType: 'Difficulty', value: 'Medium' },
            { traitType: 'Volume Required', value: '$100' },
            { traitType: 'Points', value: 200 },
        ],
    },
    [BadgeType.SWAP_MASTER]: {
        name: 'Swap Master',
        description: 'Completed 100+ swaps on Jupiter',
        rarity: BadgeRarity.EPIC,
        image: 'https://defi-quest-home.netlify.app/badges/swap-master.png',
        attributes: [
            { traitType: 'Category', value: 'Trading' },
            { traitType: 'Difficulty', value: 'Hard' },
            { traitType: 'Swaps Required', value: 100 },
    ...
    [BadgeType.STREAK_STARTER]: {
        ...
        rarity: BadgeRarity.COMMON,
        image: 'https://defi-quest-home.netlify.app/badges/streak-starter.png',
        attributes: [
            { traitType: 'Category', value: 'Streak' },
            { traitType: 'Days Required', value: 7 },
    ...
    [BadgeType.LIMIT_ORDER_PRO]: {
        ...
        description: 'Executed 5+ limit orders using Jupiter Trigger',
        rarity: BadgeRarity.RARE,
        image: 'https://defi-quest-home.netlify.app/badges/limit-order-pro.png',
        attributes: [
            { traitType: 'Category', value: 'DeFi' },
            { traitType: 'Difficulty', value: 'Medium' },
    ...
    [BadgeType.HACKATHON_PARTICIPANT]: {
        name: 'Matrix Hackathon Participant',
        description: 'Participated in the Play Solana Matrix Hackathon 2026',
        rarity: BadgeRarity.LEGENDARY,
        image: 'https://defi-quest-home.netlify.app/badges/hackathon-participant.png',
        externalUrl: 'https://playsolana.com',
        attributes: [
            { traitType: 'Category', value: 'Special' },
            { traitType: 'Event', value: 'Matrix Hackathon 2026' },
            { traitType: 'Edition', value: 'Limited' },
            { traitType: 'Points', value: 1000 },
        ],
    },
